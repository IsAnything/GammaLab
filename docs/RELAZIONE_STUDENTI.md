...
*   **Matematica Avanzata**: Per capire da dove arriva un raggio gamma, dobbiamo analizzare la forma della macchia di luce che lascia sulla telecamera. Abbiamo usato l'algebra lineare e il calcolo dei **momenti statistici** per disegnare un'ellisse perfetta attorno allo sciame. In pratica, calcoliamo quanto è forte il segnale (momento 0), dov'è il suo baricentro (momento 1) e quanto è allungato (momento 2). Questo ci permette di **identificare la sorgente**: ellissi compatte indicano una sorgente puntiforme (come la Crab Nebula), forme più estese rivelano oggetti giganti (come i Resti di Supernova), mentre macchie larghe e caotiche sono solo il "rumore" dei raggi cosmici.
